 ...
 */
void AnaStep1(const int run_id, const string fn_raw, const string fn_rec, const int n_evt=0)
{
  const string ds="6"; // Only dataset 6 is supported at present.
  ...
  //if (dir_out == "") ana->SetOutputDir(run_id);
  //else               ana->SetOutputDir(dir_out);
